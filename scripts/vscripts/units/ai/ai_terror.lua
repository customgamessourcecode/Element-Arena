function Spawn( entityKeyValues )
	...
	swapAbility = thisEntity:FindAbilityByName( "terrorblade_sunder" )
	buffAbility = thisEntity:FindAbilityByName( "my_post_buff" )
...
function TitanTankThink()
    ...
    if swapAbility ~= nil and swapAbility:IsFullyCastable() and unitmaxhealth ~= nil then
...
function swap( enemy )
	...
	ExecuteOrderFromTable({
		...
		AbilityIndex = swapAbility:entindex(),
