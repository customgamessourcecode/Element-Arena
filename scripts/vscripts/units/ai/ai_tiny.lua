function Spawn( entityKeyValues )
	...
	thisEntity:SetContextThink( "TinyThink", TitanTankThink, 1 )
end
...
function TitanTankThink()
    ...
    if tossAbility ~= nil and tossAbility:IsFullyCastable() and enemies[1] ~= nil then
        enemies = FindUnitsInRadius( thisEntity:GetTeamNumber(), thisEntity:GetOrigin(), nil, 9999, DOTA_UNIT_TARGET_TEAM_ENEMY, DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC, DOTA_UNIT_TARGET_FLAG_MAGIC_IMMUNE_ENEMIES + DOTA_UNIT_TARGET_FLAG_FOW_VISIBLE, FIND_CLOSEST, false )
        local maxdist = 0
