...
function Spawn( entityKeyValues )
	...
	thisEntity.hArrowAbility = thisEntity:FindAbilityByName( "techies_remote_mines_datadriven" )

	thisEntity:SetContextThink( "BanditTechiesThink", BanditTechiesThink, 0.5 )
end

--------------------------------------------------------------------------------

function BanditTechiesThink()
	if not IsServer() then
		return
	end
